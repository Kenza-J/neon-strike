  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-6">
      <div className="w-full max-w-md bg-[#0f0f10] border border-white/10 rounded-2xl p-8">
        ...
        <h1 className="text-3xl font-black uppercase mb-2">Connexion</h1>
        <p className="text-gray-500 text-sm mb-8">Accédez à votre compte Neon Strike</p>
        ...
        <p className="text-center text-gray-500 text-sm mt-6">
          ...
          <Link href="/auth/register" className="text-purple-400 hover:text-purple-300 font-bold">
            Créer un compte
          </Link>
        </p>
